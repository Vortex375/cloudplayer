 ...
 * the License.
 */
package de.pandaserv.music.mobile.client;
...
import de.pandaserv.music.mobile.client.css.AppBundle;
...
public class MgwtAppEntryPoint implements EntryPoint {
    ...
    MGWT.applySettings(MGWTSettings.getAppSetting());
		...
		historyHandler.register(clientFactory.getPlaceController(), clientFactory.getEventBus(), new de.pandaserv.music.mobile.client.activities.HomePlace());
